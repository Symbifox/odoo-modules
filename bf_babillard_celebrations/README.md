# Babillard : célébrations (`bf_babillard_celebrations`)

A bridge between the noticeboard (`bf_babillard`) and Celebrations (`bf_celebrations`). It installs itself as soon as both modules are present.
