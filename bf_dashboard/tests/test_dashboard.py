# -*- coding: utf-8 -*-
"""Le tableau de bord a un seul devoir : ne jamais casser la page.
...
from odoo.addons.bf_dashboard.models.bf_dashboard import REQUIREMENTS
from odoo.tests import TransactionCase, tagged

SECTIONS = (
    "revenue", "hosting", "knowledge", "privacy", "reconciliation",
...
class TestBfDashboard(TransactionCase):
    ...
    def test_inheritance_anchors_still_resolve(self):
        ...
        path = "%s/static/src/xml/bf_dashboard.xml" % get_module_path("bf_dashboard")
    ...
    def test_no_post_init_hook_rewrites_personal_settings(self):
        ...
        path = "%s/__manifest__.py" % get_module_path("bf_dashboard")
