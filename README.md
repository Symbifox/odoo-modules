...
| `bf_babillard` | Babillard | 18.0.1.7.2 | BUSL-1.1 | Announcements with an audience, an expiry date and named read receipts, with a confidential reporting path |
...
| `bf_capture` | Captation audio | 18.0.1.2.2 | BUSL-1.1 | Record a meeting or a memo from a phone; the server names the file and drops it where the rest is already automatic |
...
| `bf_meeting_timer` | Chronomètre de rencontre | 18.0.1.2.2 | BUSL-1.1 | The real time each agenda topic actually took, and the projected end of the meeting while it is still running. |
