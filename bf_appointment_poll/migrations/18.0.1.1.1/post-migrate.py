# -*- coding: utf-8 -*-
"""Rafraîchit de nouveau les deux gabarits (correction de rédaction).

Même mécanisme que la 18.0.1.1.0, même raison : `noupdate="1"` protège les
gabarits, donc un `-u` seul ne les touche pas. Ici la correction porte sur
l'élision — le nom du sondage est saisi par l'organisateur et peut commencer
par une voyelle, ce qui donnait « au sujet de Atelier ». Le nom est désormais
toujours isolé entre guillemets derrière un nom générique.

Note historique de la 18.0.1.1.0 :
