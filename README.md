...
| `bf_property_portal` | Copropriété — Portail de l'occupant | 18.0.2.0.0 | BUSL-1.1 | Announcements, documents, syndicat contact details and maintenance requests on the Odoo portal, with the audience of each piece enforced by record rules: a tenant is in the register under article 1070 without having access to it, publishing a register item asks the syndicat to acknowledge that it goes beyond article 1070.1, and who bears the cost of a request follows the three regimes of article 1064 |
