...
| `bf_email_management` | Gestion des courriels | 18.0.9.9.0 | BUSL-1.1 | Unified IMAP inbox + Odoo chatter projection, two-pane OWL folder browser (Apple Mail / Thunderbird), bulk per-row target inference |
| `bf_email_systray` | Boîte de réception bf.email — barre Odoo | 18.0.1.2.0 | LGPL-3 | Systray button opening the bf.email inbox with a (read + unread) counter |
