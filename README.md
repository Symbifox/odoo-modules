...
| `bf_federation` | Fédération | 18.0.1.1.0 | LGPL-3 | Federate two Odoo/Symbifox instances: share tasks with the other side, with state, deadline day, messages and attachments following both ways |
