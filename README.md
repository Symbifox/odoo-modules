...
| `bf_cx` | Expérience client | 18.0.1.6.2 | BUSL-1.1 | Customer experience measurement: NPS programs, continuous feedback, complaints and consent-tracked testimonials |
...
| `bf_email_management` | Gestion des courriels | 18.0.9.8.0 | BUSL-1.1 | Unified IMAP inbox + Odoo chatter projection, two-pane OWL folder browser (Apple Mail / Thunderbird), bulk per-row target inference |
