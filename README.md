...
| `bf_property_portal` | Copropriété — Portail de l'occupant | 18.0.3.1.0 | BUSL-1.1 | Announcements, documents, syndicat contact details, maintenance requests and booking of the common spaces, on the Odoo portal, with the audience of each piece enforced by record rules: a tenant is in the register under article 1070 without having access to it, publishing a register item asks the syndicat to acknowledge that it goes beyond article 1070.1, who bears the cost of a request follows the three regimes of article 1064, and a restricted-use space under article 1043 is bookable only by the fractions that hold it |
