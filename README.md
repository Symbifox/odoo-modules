...
| `bf_appointment` | Symbifox Appointment | 18.0.2.46.0 | BUSL-1.1 | Self-service public booking pages (extends `resource_booking`) |
...
| `bf_cx` | Expérience client | 18.0.1.7.0 | BUSL-1.1 | Customer experience measurement: NPS programs, continuous feedback, complaints and consent-tracked testimonials |
...
| `project_knowledge_matrix` | Project Knowledge Matrix | 18.0.11.2.0 | BUSL-1.1 | Project knowledge base, policies, and documentation |
<!-- MODULES_TABLE:END -->
