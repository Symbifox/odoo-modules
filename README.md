...
| `bf_meeting_timer` | Chronomètre de rencontre | 18.0.1.4.0 | BUSL-1.1 | The real time each agenda topic actually took, and the projected end of the meeting while it is still running. |
