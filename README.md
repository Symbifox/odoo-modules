...
| `hosting_management` | Gestion d'hébergement | 18.0.2.51.2 | BUSL-1.1 | Manage hosting services, client computer parks (endpoints, BitLocker, Action1 sync) and software license pools |
